...
import Alljobs from "../pages/employeeDashboard/Alljobs";
import JobCandidates from "../pages/employeeDashboard/JobCandidates";
import Candidate from "../components/reusable/Candidate";
